      ...
      googleLogin(code).then((result) => {
        if (result.success) {
          ...
          addToast(
            ...
            result.message || "Unable to complete Google sign in"
          );
          router.push("/auth");
        }
      });
      ...
      >
        <div className='relative mb-6'>
          <motion.div
            ...
            className='w-16 h-16 mx-auto rounded-2xl bg-linear-to-br from-teal-400 to-emerald-500 flex items-center justify-center'
          >
