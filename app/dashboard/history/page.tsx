...
import { History, Search, Filter, FileText, Mail, MessageSquare, Code, Trash2, Copy, Check } from "lucide-react"
    ...
    <div className="max-w-4xl mx-auto">
      <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-white">Generation History</h1>
        </div>
        <p className="text-slate-400">View and manage your previously generated content</p>
      </motion.div>
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-slate-400 line-clamp-2 mb-2">{item.preview}</p>
                  <div className="flex items-center justify-between">
                    <span className="text-xs text-slate-500">{item.tokens} tokens</span>
