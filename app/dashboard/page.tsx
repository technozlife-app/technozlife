...
const mockActivities = [
  { id: "1", type: "generation", description: "Generated blog post about AI trends", timestamp: "2 minutes ago" },
  { id: "2", type: "document", description: "Saved email template 'Welcome Series'", timestamp: "15 minutes ago" },
  { id: "3", type: "generation", description: "Created social media content batch", timestamp: "1 hour ago" },
  { id: "4", type: "settings", description: "Updated notification preferences", timestamp: "3 hours ago" },
  { id: "5", type: "payment", description: "Monthly subscription renewed", timestamp: "Yesterday" },
]
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="mb-6 md:mb-8">
        ...
        <p className="text-slate-400">Here's what's happening with your bio-digital interface</p>
      </motion.div>
        ...
        <div className="space-y-4 md:space-y-6">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                { icon: Cpu, label: "New Project", color: "from-teal-500/20 to-emerald-500/20" },
                { icon: FileText, label: "Templates", color: "from-violet-500/20 to-purple-500/20" },
              ].map((action) => (
                <button
                  key={action.label}
