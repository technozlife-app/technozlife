...
const categories = ["All", "Research", "Philosophy", "Science", "Ethics", "Engineering", "Stories"]
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-slate-400 max-w-2xl mx-auto leading-relaxed">
              Exploring the frontiers of human potential through technology, ethics, and innovation.
            </p>
          </motion.div>
            ...
            >
              <Link href={`/blog/${featuredPost.slug}`} className="group block">
                <div className="relative glass rounded-3xl overflow-hidden">
                  {/* Glow effect */}
                  <div className="absolute -inset-1 bg-gradient-to-r from-teal-500/20 via-violet-500/20 to-emerald-500/20 rounded-3xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />

                  <div className="relative flex flex-col lg:flex-row">
                    {/* Image */}
                    <div className="lg:w-1/2 relative overflow-hidden">
                      <div className="absolute inset-0 bg-gradient-to-r from-transparent to-slate-950/80 z-10 lg:block hidden" />
                      <motion.img
                        src={featuredPost.coverImage}
                        alt={featuredPost.title}
                        className="w-full h-64 lg:h-full object-cover group-hover:scale-105 transition-transform duration-700"
                      />
                      <Badge className="absolute top-6 left-6 z-20 bg-teal-500 text-slate-950 border-0">Featured</Badge>
                    </div>

                    {/* Content */}
                    <div className="lg:w-1/2 p-8 lg:p-12 flex flex-col justify-center">
                      <Badge variant="outline" className="w-fit mb-4 border-violet-500/30 text-violet-400">
                      ...
                      <p className="text-slate-400 mb-6 leading-relaxed line-clamp-3">{featuredPost.excerpt}</p>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          />
                          <div>
                            <p className="text-sm font-medium text-slate-200">{featuredPost.author.name}</p>
              ...
              >
                <Link href={`/blog/${post.slug}`} className="group block">
                  <article className="relative glass rounded-2xl p-6 hover:bg-slate-800/30 transition-all duration-300">
                    {/* Hover glow */}
                    <div className="absolute -inset-px bg-gradient-to-r from-teal-500/0 via-teal-500/10 to-violet-500/0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
          ...
          >
            ...
            <div className="relative">
              ...
              <p className="text-slate-400 mb-8 max-w-xl mx-auto">
                Subscribe to our newsletter for the latest insights on neural technology, AI ethics, and the future of
                human potential.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="px-8 py-3 bg-gradient-to-r from-teal-500 to-emerald-500 text-slate-950 font-semibold rounded-xl hover:shadow-lg hover:shadow-teal-500/25 transition-all"
                >
                  Subscribe
                </motion.button>
              </div>
