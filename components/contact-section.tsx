  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        addToast("error", "Failed to Send", result.message || "Please try again later")
      }
    } catch {
      addToast("error", "Connection Error", "Unable to reach server. Please try again.")
    } finally {
      setIsLoading(false)
    }
  }
      ...
      <div className="relative max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-lg text-slate-400 max-w-2xl mx-auto">
            Take the first step towards bio-digital integration. Our team is ready to guide you through the process.
          </p>
        </motion.div>
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16">
          ...
          >
            ...
            <p className="text-slate-400 mb-8 leading-relaxed">
              Whether you're ready to start your journey or simply curious about the possibilities, we're here to answer
              your questions and guide you forward.
            </p>
            ...
            <div className="glass rounded-xl p-6">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div className="text-sm text-slate-400">
                  Join <span className="text-teal-400 font-medium">2,000+</span> others who connected this month
                </div>
              </div>
            ...
            <div className="glass-strong rounded-2xl p-8 md:p-10 glow-teal">
              {isSubmitted ? (
                ...
                >
                  ...
                  <h3 className="text-2xl font-semibold text-slate-100 mb-3">Message Received</h3>
                  <p className="text-slate-400">
                    Thank you for reaching out. Our team will contact you within 24 hours to begin your journey.
                  </p>
                  <Button
                    variant="outline"
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <Button
                    type="submit"
                    disabled={isLoading}
                    className="w-full bg-gradient-to-r from-teal-500 to-emerald-500 text-slate-950 font-semibold hover:from-teal-400 hover:to-emerald-400 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {isLoading ? (
