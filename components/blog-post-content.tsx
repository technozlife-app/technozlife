...
import { ArrowLeft, Clock, Calendar, Twitter, Linkedin, Link2, ArrowUpRight } from "lucide-react"
        ...
        <header className="px-6 pt-8 pb-12">
          <div className="max-w-4xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
              <Badge variant="outline" className="mb-6 border-violet-500/30 text-violet-400 px-4 py-1.5">
                {post.category}
              </Badge>
              ...
              <div className="flex flex-wrap items-center gap-6 pb-8 border-b border-slate-800/50">
                <div className="flex items-center gap-4">
                  ...
                  />
                  <div>
                    <p className="font-medium text-slate-100">{post.author.name}</p>
        ...
        >
          <div className="max-w-5xl mx-auto">
            <div className="relative rounded-3xl overflow-hidden">
              <div className="absolute -inset-2 bg-gradient-to-r from-teal-500/20 via-violet-500/20 to-emerald-500/20 rounded-3xl blur-xl" />
              <img
          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              <div className="flex flex-col sm:flex-row items-start gap-6">
                ...
                />
                <div>
                  <p className="text-sm text-teal-400 font-medium mb-1">Written by</p>
                  <h3 className="text-xl font-bold text-slate-100 mb-1">{post.author.name}</h3>
                  <p className="text-slate-400 mb-4">{post.author.role}</p>
                  <p className="text-slate-500 text-sm leading-relaxed">
                    Dedicated to pushing the boundaries of what's possible at the intersection of humanity and
                    technology.
                  </p>
                </div>
              </div>
                  ...
                  <Link href={`/blog/${relatedPost.slug}`} className="group block h-full">
                    <article className="relative glass rounded-2xl overflow-hidden h-full hover:bg-slate-800/30 transition-all duration-300">
                      ...
                      <div className="relative">
                        ...
                        <div className="p-6">
                          <Badge variant="outline" className="mb-3 border-slate-600 text-slate-400 text-xs">
