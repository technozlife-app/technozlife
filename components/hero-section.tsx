...
function FloatingOrb({
  ...
  size,
  color,
}: { delay: number; x: string; y: string; size: string; color: string }) {
  return (
    <motion.div
...
export function HeroSection() {
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      {/* Floating orbs */}
      <FloatingOrb delay={0.2} x="left-[10%]" y="top-[20%]" size="w-64 h-64" color="bg-teal-500/20" />
      <FloatingOrb delay={0.4} x="right-[15%]" y="top-[30%]" size="w-48 h-48" color="bg-violet-500/15" />
      <FloatingOrb delay={0.6} x="left-[20%]" y="bottom-[20%]" size="w-56 h-56" color="bg-emerald-500/10" />
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        >
          ...
          <span className="text-sm text-slate-300">Pioneering the Future of Human-Tech Integration</span>
        </motion.div>
        ...
        >
          Transform your existence with cutting-edge technology that seamlessly integrates with human potential.
