          ...
          >
            ...
            <Link href="/" className="flex items-center gap-3 mb-6 group">
              <div className="relative w-10 h-10">
                <div className="absolute inset-0 bg-gradient-to-br from-teal-500 to-emerald-500 rounded-xl rotate-45 group-hover:rotate-[55deg] transition-transform duration-300" />
              ...
              <span className="text-xl font-bold text-slate-100">Technozlife</span>
            </Link>

            <p className="text-slate-400 mb-6 leading-relaxed">
              Pioneering the convergence of humanity and technology. Building the future of bio-digital integration, one
              neural pathway at a time.
            </p>
          ...
          <div className="flex-1 grid grid-cols-2 md:grid-cols-3 gap-8">
            {Object.entries(footerLinks).map(([category, links], categoryIndex) => (
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <h4 className="text-sm font-semibold text-slate-200 uppercase tracking-wider mb-4">{category}</h4>
        ...
        >
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm text-slate-600">
              &copy; {new Date().getFullYear()} Technozlife. All rights reserved.
            </p>
            <div className="flex items-center gap-6">
              <span className="text-xs text-slate-600">Crafted for the future of humanity</span>
